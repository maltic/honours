...
While the average accuracy was slightly better than Zukers algorithm, this may have been due to chance. The only conclusion we can draw is that both algorithms perform similarly. This was not the expected result.

Theoretical complexity confirmed with empirical observation. Possibly the fastest known algorithm.
...
lessons for RNA design, GC pairs and other rules
